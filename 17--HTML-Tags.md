...
<a href="/" class="brand-link" itemprop="url"><img alt="Code School" class="brand-img" height="34" itemprop="logo" src="https://d1tijy5l7mg5kk.cloudfront.net/assets/logo-dd0420d66e370a02a3f4ba92e67ebb3a.svg" width="189" />
</a></div>
</div>
...
<li class='nav-item list-item'><a href="https://www.codeschool.com/courses" class="nav-item-link list-item-link">Courses</a></li>
<li class='nav-item list-item'><a href="https://www.codeschool.com/screencasts" class="nav-item-link list-item-link">Screencasts</a></li>
<li class='nav-item list-item'><a href="https://www.codeschool.com/enroll" class="nav-item-link list-item-link" data-segment-link="User Clicked Enroll" data-segment-properties="{&quot;source&quot;:&quot;Main Navigation&quot;}">Enroll</a></li>
<li class='nav-item nav-item--btn list-item'><a href="https://www.codeschool.com/users/sign_up" class="btn btn--a list-item-link">Create Free Account</a></li>
<li class='nav-item list-item'><a href="https://www.codeschool.com/users/sign_in" class="nav-item-link list-item-link">Sign in</a></li>
</ol>
</nav>
 ...
 <header id="masthead" class="masthead" role="banner">
    ...
    <svg class="nyt-logo" width="379" height="64" role="img" aria-label="The New York Times">
        ...
        <ul class="masthead-menu">
            <li class="date">Tuesday, October 21, 2014</li><li class="todays-paper"><a href="http://www.nytimes.com/pages/todayspaper/index.html" data-collection="todays-paper"><i class="icon"></i>Today’s Paper</a></li><li class="video"><a href="http://www.nytimes.com/video" data-collection="video"><i class="icon"></i>Video</a></li><li class="weather"><a href="http://www.nytimes.com/weather" data-collection="weather">Weather</a></li>
        </ul>
        ...
        <li>
            ...
            <button class="button search-button">
                ...
                <li class="shortcuts-D9C94A2B-0364-4D25-8383-592CC66F82D4 domestic">
                    <a href="http://www.nytimes.com/pages/dining/index.html">Dining</a>
                </li>


                <li class="shortcuts-FDEFB811-B483-4C3D-A25A-FD07BE5EAD96 international">
                    <a href="http://www.nytimes.com/pages/dining/international/index.html">Dining</a>
                </li>
...
<div align="right"><a href="http://thescene.com/wired">More Wired Video at The Scene></a></div>
</blockquote>
```
...
<figure class="media photo">
    <div class="image">
        <a href="http://www.nytimes.com/2014/10/21/us/politics/iowa-senate-election.html"><img src="http://static01.nyt.com/images/2014/10/18/us/Iowa-PROMO/Iowa-PROMO-largeHorizontal375.jpg" alt=""></a>
    </div>
    <figcaption class="caption" itemprop="description">
                    <span class="caption-text">Iowa's landscape has been changing, giving rise to sights like wind turbines in a cornfield outside Blairsburg.</span>
...
<figure class="media photo medium-thumb">
    <div class="image">
        <a href="http://www.nytimes.com/2014/10/22/arts/music/john-adams-death-of-klinghoffer-metropolitan-opera-debut.html"><img src="http://static01.nyt.com/images/2014/10/22/arts/music/22klinghoffer1/22klinghoffer1-mediumFlexible177-v2.jpg" alt="" /></a>
    </div>
    <figcaption class="caption" itemprop="description">
                    <span class="credit" itemprop="copyrightHolder">
                <span class="visually-hidden">Credit</span>
...
<fieldset class='form-field'>
<label class="form-label" data-required="true" for="user_login">Email or Username</label><input class="form-input" id="user_login" name="user[login]" size="30" type="text" />

</fieldset>
<fieldset class='form-field'>
<label class="form-label" data-required="true" for="user_password">Password</label><input class="form-input" id="user_password" name="user[password]" size="30" type="password" />

<a href="/users/password/new" class="bdrn tss"><i class='icn icn--question'></i>
<b>Forgot your password?</b>
</a></fieldset>
<fieldset class='form-field mtl tac'>
<input class="form-btn btn sign-in-submit" data-disable-with="Signing in..." name="create_new_user_session" type="submit" value="Sign In" />
</fieldset>
</form>
```
[codeschool.com](www.codeschool.com/enrollment/new)
...
<input id="subscription_plan_id" name="subscription[plan_id]" type="hidden" />
<input id="subscription_quantity" name="subscription[quantity]" type="hidden" />
<input id="subscription_payment_method" name="subscription[payment_method]" type="hidden" />
</form>
```
[codeschool.com](www.codeschool.com/enrollment/new)
##`<section>`
...
<section class="landing-pages">
 ...
 <div class="panel performance">
   <a href="/en/features/performance">
     <div class="left">
       <div class="icon"></div>
     </div>
     <div class="right">
